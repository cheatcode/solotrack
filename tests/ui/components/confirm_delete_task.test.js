...
test.that('confirm delete task renders dialog elements', async (assert = {}) => {
  const component = await test.render('ui/components/confirm_delete_task/index.js', {
    options: {
      language: 'en-US',
    },
  });
  ...
  assert.is(html.includes('data-mod-dialog="confirm_delete_task"'), true);
...
test.that('confirm delete task renders action buttons', async (assert = {}) => {
  const component = await test.render('ui/components/confirm_delete_task/index.js', {
    options: {
      language: 'en-US',
    },
...
test.that('confirm delete task uses internationalization', async (assert = {}) => {
  const component = await test.render('ui/components/confirm_delete_task/index.js', {
    options: {
      language: 'en-US',
    },
  ...
  assert.is(html.includes('confirm_delete_task.title'), false);
  assert.is(html.includes('confirm_delete_task.subtitle'), false);
  assert.is(html.includes('confirm_delete_task.action.cancel'), false);
  assert.is(html.includes('confirm_delete_task.action.confirm'), false);
});

test.that('confirm delete task has warning styling', async (assert = {}) => {
  const component = await test.render('ui/components/confirm_delete_task/index.js', {
    options: {
      language: 'en-US',
    },
...
test.that('confirm delete task renders with proper dialog structure', async (assert = {}) => {
  const component = await test.render('ui/components/confirm_delete_task/index.js', {
    options: {
      language: 'en-US',
    },
  ...
  assert.is(html.includes('<div data-mod-dialog="confirm_delete_task" class="mod-dialog">'), true);
...
test.that('confirm delete task has accessible button attributes', async (assert = {}) => {
  const component = await test.render('ui/components/confirm_delete_task/index.js', {
    options: {
      language: 'en-US',
    },
